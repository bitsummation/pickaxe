...
namespace Pickaxe.Parser.Bridge
{
    internal interface IBridgeVisitor
    {
        ...
        void Visit(NestedSelectStatement statement, CommonTree tree);
        ...
        void Visit(IdentityVariable identity, CommonTree tree);
        void Visit(CommandLineVariable variable, CommonTree tree);
        ...
        void Visit(JSTableHint hing, CommonTree tree);
        void Visit(ThreadTableHint hint, CommonTree tree);
