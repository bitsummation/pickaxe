...
public partial class ScrapeParser : Antlr.Runtime.Parser
{
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> procedureDefinition()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: ID, tableColumnArgs, block, PROCEDURE
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> updateStatment()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: whereStatement, fromStatement, setArgs, UPDATE, ID
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> fromStatement()
	{
		...
		try
		{
			...
			case 2:
				...
				{
				// AST REWRITE
				// elements: FROM, ID, tableHint, innerJoinStatement, tableGenerationClause
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
