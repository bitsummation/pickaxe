...
// $ANTLR 3.5.2 Scrape.g 2016-04-09 10:44:22
...
public partial class ScrapeParser : Antlr.Runtime.Parser
{
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> expandExpression()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: expandBlock, expandVar, EXPAND, expandVar
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> updateStatment()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: fromStatement, ID, UPDATE, whereStatement, setArgs
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> fromStatement()
	{
		...
		try
		{
			...
			case 3:
				...
				{
				// AST REWRITE
				// elements: FROM, tableHint, tableGenerationClause, ID
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> createTableStatement()
	{
		...
		try
		{
			...
			case 1:
				...
				{
				// AST REWRITE
				// elements: fileTableWithStatement, ID, fileTableLocation, tableColumnArgs
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
