...
// $ANTLR 3.5.2 Scrape.g 2017-03-06 09:26:12
...
public partial class ScrapeParser : Antlr.Runtime.Parser
{
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> updateStatment()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: ID, setArgs, whereStatement, fromStatement, UPDATE
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> fromStatement()
	{
		...
		try
		{
			...
			case 2:
				...
				{
				// AST REWRITE
				// elements: tableGenerationClause, FROM, ID, innerJoinStatement, tableHint
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
			...
			case 3:
				...
				{
				// AST REWRITE
				// elements: innerJoinStatement, ID, nestedSqlStatement, FROM
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> innerJoinStatement()
	{
		...
		try
		{
			...
			case 2:
				...
				{
				// AST REWRITE
				// elements: innerJoinStatement, ID, boolExpression, nestedSqlStatement
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
